...
namespace MinorShift.Emuera.GameProc
{
    ...
    /// 命令文1行に相当する抽象クラス
    /// </summary>
    public abstract class LogicalLine
	{
    ...
    /// @で始まるラベル行
    /// </summary>
    public class FunctionLabelLine : LogicalLine, IComparable<FunctionLabelLine>
	{
		protected FunctionLabelLine() { }
		internal FunctionLabelLine(ScriptPosition thePosition, string labelname, WordCollection wc)
		{
			base.position = thePosition;
			LabelName = labelname;
			IsSingle = false;
		...
		WordCollection wc;
		internal WordCollection PopRowArgs()
		{
		...
		internal VariableTerm[] Arg { get; set; }
        internal SingleTerm[] Def { get; set; }
